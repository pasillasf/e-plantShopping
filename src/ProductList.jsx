...
function ProductList({ onHomeClick }) {
    ...
    const handleAddToCart = (product) => {
        //console.log('begin handleaddtocart');
        //console.log(product);
        //console.log(true);
        dispatch(addItem(product)); // Dispatch the action to add the product to the cart (Redux action)
        //console.log('finish handleaddtocart');
                ...
                <div style={styleObjUl}>
                    ...
                    <div style={{ position: 'relative' }}>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            ...
                            {/* 🎯 Badge displaying total quantity */}
                        ...
                        {category.plants.map((plant, plantIndex) => ( // Loop through each plant in the current category
                            ...
                            <div className="product-price">${plant.cost}</div> {/* Display plant cost */}
                                <button
                                    ...
                                    disabled={addedToCart[plant.name]} // ✅ Disable if item was added
                                >
